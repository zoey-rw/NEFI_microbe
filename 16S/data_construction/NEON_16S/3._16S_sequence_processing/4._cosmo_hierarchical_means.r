...
NEON_cosmo_abundances_16S.path <- "/projectnb/talbot-lab-data/NEFI_data/16S/pecan_gen/NEON_cosmo_abundances_16S.rds"
...
d <- readRDS(NEON_cosmo_abundances_16S.path)
fg.c <- d$abundances
fg.c$other <- NULL
