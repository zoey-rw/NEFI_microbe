...
#load data
plot_data <- readRDS(dp1.10098.00_plot.level_16S.path)
...
#save output.----
saveRDS(plot.out, plot_plot_16S.path)
saveRDS(site.out, plot_site_16S.path)
saveRDS(glob.out, plot_glob_16S.path)
