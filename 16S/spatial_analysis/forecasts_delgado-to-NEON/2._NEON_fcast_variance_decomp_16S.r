...
for (p in 1:length(all.mod)){
  ...
  core_cov <- ddirch_forecast_noLogMap(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_process_uncertainty = T, zero_parameter_uncertainty = T)
  core_par <- ddirch_forecast_noLogMap(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_process_uncertainty = T, zero_covariate_uncertainty = T)
  core_pro <- ddirch_forecast_noLogMap(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_parameter_uncertainty = T, zero_covariate_uncertainty = T)
  core_cov.par <- ddirch_forecast_noLogMap(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_process_uncertainty = T)
  core_cov.pro <- ddirch_forecast_noLogMap(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_parameter_uncertainty = T)
  core_par.pro <- ddirch_forecast_noLogMap(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_covariate_uncertainty = T)
  ...
  plot_ref <- ddirch_forecast_noLogMap(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale')
  plot_cov <- ddirch_forecast_noLogMap(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_process_uncertainty = T, zero_parameter_uncertainty = T)
  plot_par <- ddirch_forecast_noLogMap(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_process_uncertainty = T, zero_covariate_uncertainty = T)
  plot_pro <- ddirch_forecast_noLogMap(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_parameter_uncertainty = T, zero_covariate_uncertainty = T)
  plot_cov.par <- ddirch_forecast_noLogMap(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_process_uncertainty = T)
  plot_cov.pro <- ddirch_forecast_noLogMap(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_parameter_uncertainty = T)
  plot_par.pro <- ddirch_forecast_noLogMap(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_covariate_uncertainty = T)
  ...
  site_ref <- ddirch_forecast_noLogMap(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale')
  site_cov <- ddirch_forecast_noLogMap(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_process_uncertainty = T, zero_parameter_uncertainty = T)
  site_par <- ddirch_forecast_noLogMap(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_process_uncertainty = T, zero_covariate_uncertainty = T)
  site_pro <- ddirch_forecast_noLogMap(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_parameter_uncertainty = T, zero_covariate_uncertainty = T)
  site_cov.par <- ddirch_forecast_noLogMap(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_process_uncertainty = T)
  site_cov.pro <- ddirch_forecast_noLogMap(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_parameter_uncertainty = T)
  site_par.pro <- ddirch_forecast_noLogMap(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_covariate_uncertainty = T)
