#Getting site-level NEON data for site-level prediction - 16S.
...
site_output_path <- NEON_site_covs_16S.path
glob_output.path <- NEON_glob_covs_16S.path

#load core level data.
core.dat <- readRDS(core.table_16S.path)
...
plot.dat <- readRDS(plot.table_16S.path)
...
site.dat <- readRDS(site_level_data_16S.path)
