...
#set output paths.----
output.path <- NEON_dmulti.ddirch_var.decomposition_cosmo.path
...
core_ref <- dmulti_ddirch_forecast(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale')
core_cov <- dmulti_ddirch_forecast(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_process_uncertainty = T, zero_parameter_uncertainty = T)
core_par <- dmulti_ddirch_forecast(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_process_uncertainty = T, zero_covariate_uncertainty = T)
core_pro <- dmulti_ddirch_forecast(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_parameter_uncertainty = T, zero_covariate_uncertainty = T)
core_cov.par <- dmulti_ddirch_forecast(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_process_uncertainty = T)
core_cov.pro <- dmulti_ddirch_forecast(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_parameter_uncertainty = T)
core_par.pro <- dmulti_ddirch_forecast(mod = mod, cov_mu = core_median_mu, cov_sd = core_median_sd, names = 'core_scale', zero_covariate_uncertainty = T)
...
plot_ref <- dmulti_ddirch_forecast(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale')
plot_cov <- dmulti_ddirch_forecast(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_process_uncertainty = T, zero_parameter_uncertainty = T)
plot_par <- dmulti_ddirch_forecast(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_process_uncertainty = T, zero_covariate_uncertainty = T)
plot_pro <- dmulti_ddirch_forecast(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_parameter_uncertainty = T, zero_covariate_uncertainty = T)
plot_cov.par <- dmulti_ddirch_forecast(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_process_uncertainty = T)
plot_cov.pro <- dmulti_ddirch_forecast(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_parameter_uncertainty = T)
plot_par.pro <- dmulti_ddirch_forecast(mod = mod, cov_mu = plot_median_mu, cov_sd = plot_median_sd, names = 'plot_scale', zero_covariate_uncertainty = T)
...
site_ref <- dmulti_ddirch_forecast(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale')
site_cov <- dmulti_ddirch_forecast(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_process_uncertainty = T, zero_parameter_uncertainty = T)
site_par <- dmulti_ddirch_forecast(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_process_uncertainty = T, zero_covariate_uncertainty = T)
site_pro <- dmulti_ddirch_forecast(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_parameter_uncertainty = T, zero_covariate_uncertainty = T)
site_cov.par <- dmulti_ddirch_forecast(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_process_uncertainty = T)
site_cov.pro <- dmulti_ddirch_forecast(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_parameter_uncertainty = T)
site_par.pro <- dmulti_ddirch_forecast(mod = mod, cov_mu = site_median_mu, cov_sd = site_median_sd, names = 'site_scale', zero_covariate_uncertainty = T)
