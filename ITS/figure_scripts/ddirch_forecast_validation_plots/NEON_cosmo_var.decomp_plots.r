...
output.path <- NEON_ddirch_var.decomp_cosmo_figure.path

#load data.----
d <- readRDS(NEON_ddirch_var.decomp_cosmo.path)
...
#setup output spec.----
png(filename=output.path,width=10,height=14,units='in',res=300)
